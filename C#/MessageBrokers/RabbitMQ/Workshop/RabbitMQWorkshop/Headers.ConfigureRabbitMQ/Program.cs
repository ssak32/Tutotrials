...
namespace Headers.ConfigureRabbitMQ
{
    class Program
    {
        #region Constant Strings
        const string _queueName1 = "WSQueue.Headers1";
        const string _queueName2 = "WSQueue.Headers2";
        const string _queueName3 = "WSQueue.Headers3";
        const string _queueName4 = "WSQueue.Headers4";
        ...
        private static void CreateWorkshopExchangeAndQueue()
        {
            ...
            #region Defining Queue Header Subscriptions
            Dictionary<string, object> HeaderSubscription1 = new Dictionary<string, object>();
            HeaderSubscription1.Add("x-match", "all");
            HeaderSubscription1.Add("category", "animal");
            HeaderSubscription1.Add("type", "herbivorous");

            Dictionary<string, object> HeaderSubscription2 = new Dictionary<string, object>();
            HeaderSubscription2.Add("category", "animal");
            HeaderSubscription2.Add("type", "carnivorous");

            Dictionary<string, object> HeaderSubscription3 = new Dictionary<string, object>();
            HeaderSubscription3.Add("x-match", "any");
            HeaderSubscription3.Add("category", "animal");
            HeaderSubscription3.Add("type", "mammal");

            Dictionary<string, object> HeaderSubscription4 = new Dictionary<string, object>();
            HeaderSubscription4.Add("x-match", "any");
            HeaderSubscription4.Add("category", "plant");
            HeaderSubscription4.Add("type", "flower"); 
            #endregion
            ...
            using (var channel = connection.CreateModel())
            {
                ...
                channel.ExchangeDeclare(_exchange, ExchangeType.Headers);
                ...
                channel.QueueBind(_queueName1, _exchange, _routingKey, HeaderSubscription1);
                ...
                channel.QueueBind(_queueName2, _exchange, _routingKey, HeaderSubscription2);
                ...
                channel.QueueBind(_queueName3, _exchange, _routingKey, HeaderSubscription3);
                Console.WriteLine("Binding Exchange '" + _exchange + "' with Queue '" + _queueName3);

                channel.QueueDeclare(queue: _queueName4, durable: false, exclusive: false, autoDelete: false, arguments: null);
                Console.WriteLine("Created Queue : " + _queueName4);
                channel.QueueBind(_queueName4, _exchange, _routingKey, HeaderSubscription4);
                Console.WriteLine("Binding Exchange '" + _exchange + "' with Queue '" + _queueName4);
        ...
        private static void RemoveWorkshopExchangeAndQueue()
        {
            ...
            using (var channel = connection.CreateModel())
            {
                ...
                channel.QueueDelete(_queueName4);
                Console.WriteLine("Removed Queue : " + _queueName4);
