...
namespace ScatterGather.ConfigureRabbitMQ
{
    class Program
    {
        #region Constant Strings
        const string _queueName1 = "WSQueue.ScatterGather1";
        const string _queueName2 = "WSQueue.ScatterGather2";
        const string _queueName3 = "WSQueue.ScatterGather3";

        const string _routingKey1 = "1";
        const string _routingKey2 = "2";
        const string _routingKey3 = "3";
        const string _routingKey4 = "4";
        const string _routingKey5 = "6";
        ...
        private static void CreateWorkshopExchangeAndQueue()
        {
            ...
            using (var channel = connection.CreateModel())
            {
                ...
                channel.QueueBind(_queueName1, _exchange, _routingKey4);
                Console.WriteLine("Binding Exchange '" + _exchange + "' with Queue '" + _queueName1);
                ...
                channel.QueueBind(_queueName2, _exchange, _routingKey4);
                Console.WriteLine("Binding Exchange '" + _exchange + "' with Queue '" + _queueName2);
                channel.QueueBind(_queueName2, _exchange, _routingKey5);
                Console.WriteLine("Binding Exchange '" + _exchange + "' with Queue '" + _queueName2);
                ...
                Console.WriteLine("Binding Exchange '" + _exchange + "' with Queue '" + _queueName3);
                channel.QueueBind(_queueName3, _exchange, _routingKey5);
                Console.WriteLine("Binding Exchange '" + _exchange + "' with Queue '" + _queueName3);
